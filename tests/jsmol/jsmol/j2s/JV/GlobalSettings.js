...
this.setS ("logFile", this.vwr.getLogFileName ());
...
Clazz.defineMethod (c$, "resetValue", 
 function (name, g) {
this.setS (name, g == null ? "" : g.getParameter (name, true));
}, "~S,JV.GlobalSettings");
...
if (this.defaultLoadScript.length > 0) this.setS ("defaultLoadScript", this.defaultLoadScript);
