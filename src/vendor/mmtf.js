!(function (r, t) {
  ...
  function t (r, t, n) {
    for (var e = (r.byteLength, 0), i = n.length; i > e; e++) {
      ...
      if (o < 128) r.setUint8(t++, ((o >>> 0) & 127) | 0)
      else if (o < 2048) {
        r.setUint8(t++, ((o >>> 6) & 31) | 192), r.setUint8(
          t++,
          ((o >>> 0) & 63) | 128
        )
      } else if (o < 65536) {
        r.setUint8(t++, ((o >>> 12) & 15) | 224), r.setUint8(
          t++,
          ((o >>> 6) & 63) | 128
        ), r.setUint8(t++, ((o >>> 0) & 63) | 128)
      } else {
        if (!(o < 1114112)) throw new Error('bad codepoint ' + o)
        r.setUint8(t++, ((o >>> 18) & 7) | 240), r.setUint8(
          t++,
          ((o >>> 12) & 63) | 128
        ), r.setUint8(t++, ((o >>> 6) & 63) | 128), r.setUint8(
          t++,
          ((o >>> 0) & 63) | 128
        )
      }
  ...
  function e (r, i, o) {
    ...
    if (a === 'string') {
      var u = n(r)
      if (u < 32) return i.setUint8(o, 160 | u), t(i, o + 1, r), 1 + u
      if (u < 256) { return i.setUint8(o, 217), i.setUint8(o + 1, u), t(i, o + 2, r), 2 + u }
      if (u < 65536) { return i.setUint8(o, 218), i.setUint16(o + 1, u), t(i, o + 3, r), 3 + u }
      if (u < 4294967296) { return i.setUint8(o, 219), i.setUint32(o + 1, u), t(i, o + 5, r), 5 + u }
    }
    if (r instanceof Uint8Array) {
      var u = r.byteLength,
        s = new Uint8Array(i.buffer)
      if (u < 256) { return i.setUint8(o, 196), i.setUint8(o + 1, u), s.set(r, o + 2), 2 + u }
      if (u < 65536) {
        return i.setUint8(o, 197), i.setUint16(o + 1, u), s.set(r, o + 3), 3 +
          u
      }
      if (u < 4294967296) {
        return i.setUint8(o, 198), i.setUint32(o + 1, u), s.set(r, o + 5), 5 +
          u
      }
    }
    if (a === 'number') {
      ...
      if (r >= 0) {
        if (r < 128) return i.setUint8(o, r), 1
        if (r < 256) return i.setUint8(o, 204), i.setUint8(o + 1, r), 2
        if (r < 65536) return i.setUint8(o, 205), i.setUint16(o + 1, r), 3
        if (r < 4294967296) return i.setUint8(o, 206), i.setUint32(o + 1, r), 5
    ...
    if (r === null) return i.setUint8(o, 192), 1
    if (a === 'boolean') return i.setUint8(o, r ? 195 : 194), 1
    if (a === 'object') {
      var u,
        f = 0,
        c = Array.isArray(r)
      ...
      ) { for (var l = 0; u > l; l++) f += e(r[l], i, o + f) } else {
        for (var l = 0; u > l; l++) {
          var g = d[l];
          (f += e(g, i, o + f)), (f += e(r[g], i, o + f))
        }
      }
      return f
    }
  ...
  function i (r) {
    ...
    if (t === 'string') {
      ...
      if (e < 32) return 1 + e
      if (e < 256) return 2 + e
      if (e < 65536) return 3 + e
      if (e < 4294967296) return 5 + e
    }
    if (r instanceof Uint8Array) {
      var e = r.byteLength
      if (e < 256) return 2 + e
    ...
    if (t === 'object') {
      ...
      if (e < 16) return 1 + o
      if (e < 65536) return 3 + o
      if (e < 4294967296) return 5 + o
  ...
  function U (r) {
    if (r.length === 0) return new Int32Array()
    var t,
      n,
      e = 2
  ...
  function C (r, t) {
    ...
    for (n = 0; o > n; ++n) {
      ...
      u === 0
        ? ++a
        : u > 0
          ? ((a += Math.ceil(u / e)), u % e === 0 && (a += 1))
          : ((a += Math.ceil(u / i)), u % i === 0 && (a += 1))
    }
  ...
  function j (r, t, n, e) {
    ...
    return a.setInt32(
      0,
      r
    ), a.setInt32(4, t), n && o.set(n, 8), o.set(e, 12), o
  }
  function q (r) {
    var t = r.length,
      n = s(r)
  ...
  function H (r) {
    ...
    function o () {
      var o,
        s,
        f = r[a]
      if ((128 & f) === 0) return a++, f
      if ((240 & f) === 128) return (s = 15 & f), a++, t(s)
      if ((240 & f) === 144) return (s = 15 & f), a++, i(s)
      if ((224 & f) === 160) return (s = 31 & f), a++, e(s)
      if ((224 & f) === 224) return (o = u.getInt8(a)), a++, o
      switch (f) {
        case 192:
          return a++, null
        case 194:
      ...
      if (((p = U + 1), (U = m - 1), v && S)) {
        for (u = 0, s = S.length; s > u; u += 2) {
          var W = S[u],
            X = S[u + 1];
          ((W >= p && U >= W) || (X >= p && U >= X)) &&
            v({ atomIndex1: W, atomIndex2: X, bondOrder: E ? E[u / 2] : null })
        }
      }
      L += 1
    }
  ...
  function Z (r, t, n, e) {
    ...
    o.addEventListener(
      ...
      i,
      !0
    ), o.addEventListener('error', e, !0), (o.responseType = 'arraybuffer'), o.open('GET', t + r.toUpperCase()), o.send()
  }
  function $ (r, t, n) {
    Z(r, or, t, n)
  }
