...
module.exports = function(grunt) {
    ...
    grunt.initConfig({    
        ...
        concat : {
            ...
            big : {
                src : ['js/jquery-1.11.3.js','js/mmtf.js','js/pako_inflate.js','js/netcdfjs.js','build/3Dmol-pre.js'],
                dest : 'build/3Dmol.js'
            },
            ...
            closure : {
                src : ['build/jquery-1.11.3-min-pre.js','build/mmtf-min-pre.js','build/pako_inflate-min-pre.js','build/netcdfjs-min-pre.js','build/3Dmol-min-pre.js'],
