...
function buildLink(longname, linkText, options) {
    ...
    if (!url) {
        ...
        return util.format('<a href="%s%s%s"%s>%s</a>', prefix, url, fragmentString, classString, text);
    }
}
 ...
 */
var linkto = exports.linkto = function(longname, linkText, prefix, cssClass, fragmentId) {
