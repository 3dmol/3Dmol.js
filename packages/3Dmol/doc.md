...
<script src="https://3Dmol.csb.pitt.edu/packages/3Dmol/build/3Dmol-min.js"></script>
...
```
{@lang xml}<script src="https://3Dmol.csb.pitt.edu/packages/3Dmol/build/3Dmol-min.js"></script>
```

An un-minified file is also provided for debugging purposes:

```
{@lang xml}<script src="https://3Dmol.csb.pitt.edu/packages/3Dmol/build/3Dmol.js"></script>
```

There is also an unminified version provided without jQuery for use when compiling your own minified libraries:

```
{@lang xml}<script src="https://3Dmol.csb.pitt.edu/packages/3Dmol/build/3Dmol-nojquery.js"></script>
```
