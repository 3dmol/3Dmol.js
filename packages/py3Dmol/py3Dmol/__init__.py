...
class view(object):
    '''A class for constructing embedded 3Dmol.js views in ipython notebooks.
       ...
       http://3dmol.org/packages/3Dmol/doc/$3Dmol.GLViewer.html
    '''
    def __init__(self,query='',width=640,height=480,viewergrid=None,data=None,style=None,linked=True,options=dict(),js='https://3dmol.org/packages/3Dmol/build/3Dmol.js'):
