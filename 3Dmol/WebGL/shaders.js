...
export const ShaderUtils = {
  clone(uniformsSrc) {
    ...
    for (u in uniformsSrc) {
      ...
      if (srcValue instanceof Color) uniformsClone[u].value = srcValue.clone();
      else if (typeof srcValue === 'number') uniformsClone[u].value = srcValue;
      else if (srcValue instanceof Array) uniformsClone[u].value = [];
      else console.error('Error copying shader uniforms from ShaderLib: unknown type for uniform');
    }
...
export const ShaderLib = {
  ...
  stickimposter: {
    fragmentShader: [
      ShaderUtils.stickimposterFragmentShader,
      '    float dotProduct = dot( norm, vLight );',
