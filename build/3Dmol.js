...
$3Dmol.GLModel = (function() {
    ...
    function GLModel(mid, defaultcolors) {
        ...
        idMatrix.identity(); //perhaps this is redundant
        var noAssembly;
         ...
         * Otherwise returns a list of just the identity matrix
         *
...
$3Dmol.Parsers = (function() {
     ...
     */
    parsers.pdb = parsers.PDB = function(atoms, str, options, copyMatrices) {
